      ...
      <main>
        <section className="about-section">
          ...
          <p>
            ...
            Reprehenderit aperiam fugiat quidem nostrum, mollitia error magnam
            similique sed voluptatum ad suscipit deleniti nulla inventore,
            architecto amet esse dolores, numquam commodi.
          </p>
          <div className="skills-section">
            ...
            <div>
              <h3>Experience</h3>
              <ul>
                <li>2+ years as a web developer at Acme Inc.</li>
                <li>Freelanced for various clients on web projects</li>
